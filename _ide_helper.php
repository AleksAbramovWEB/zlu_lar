...
namespace App\Facades { 
    ...
    class MainHelperFacade {
         ...
         * @static 
         */ 
        public static function is_valid_form($field)
        {
         ...
         * @static 
         */ 
        public static function getFileS3($path)
        {
                        /** @var \App\Components\MainHelper $instance */
    ...
    class DeclinationFacade {
         ...
         * @static 
         */ 
        public static function contacts($value)
        {
                        /** @var \App\Components\Declination $instance */
